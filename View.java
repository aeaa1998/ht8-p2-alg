...
public class View {
    ...
    public <K> String selectKey(Map<String, K> map){
        ...
        while (invalid){
            selected = this.input("Ingrese la opcion que desee escojer");
            invalid = !ids.contains(selected);
        }

        return selected;
    }

    public <K> K selectObject(Map<String, K> map){
        boolean invalid = true;
